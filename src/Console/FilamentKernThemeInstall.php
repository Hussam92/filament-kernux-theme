...
namespace Kern\FilamentKernTheme\Console;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;

class FilamentKernThemeInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'filament-kernux-theme:install';
     ...
     * @var string
     */
    protected $description = 'Install Filament Kern theme assets';
    ...
    public function handle()
    {
        ...
        $this->info('Filament Kern Theme installed successfully!');
